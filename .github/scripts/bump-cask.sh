...
# DMG we just shipped and pushes the change straight to the tap's `main`.
#
# Usage:  VERSION=0.13 CASK=quill TAP_TOKEN=… bump-cask.sh /abs/path/App.dmg
#
...
CASK="${CASK:?CASK env var required (cask name without .rb, e.g. quill)}"
